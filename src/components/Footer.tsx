        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Dedicated to the development and prosperity of our community in
              the heart of the South Gondar Zone.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-center gap-2">
                Education <ExternalLink className="h-3 w-3" />
              </li>
              <li className="flex items-center gap-2">
                Health <ExternalLink className="h-3 w-3" />
              </li>
              <li className="flex items-center gap-2">
                Agriculture <ExternalLink className="h-3 w-3" />
              </li>
              <li className="flex items-center gap-2">
                Land Admin <ExternalLink className="h-3 w-3" />
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>Mekane Eyesus Town, Amhara, ET</span>
              </li>
            </ul>
          </div>
        </div>
